...
const AudioBooksTable = () => {
  const [selectedAudioBook, setSelectedAudioBook] = useState<AudioBookProps | null>(null);

  const handleViewDetails = (audioBook: AudioBookProps) => {
          ...
          {selectedAudioBook && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
              <div className="flex flex-col bg-white p-6 rounded-md shadow-lg w-96 gap-2">
                ...
                <div className="flex flex-col">
                  <strong className="text-lg">Narrator:</strong>
                ...
                <div className="flex flex-col">
                  <strong className="text-lg">Format:</strong>
